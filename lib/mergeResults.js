...
readme = readme.replace(
  /<!-- module results -->.*?<!-- end -->/ms,
  `<!-- module results -->\n\n${outputModule}\n<!-- end -->`
);
readme = readme.replace(
  /<!-- syntax results -->.*?<!-- end -->/ms,
  `<!-- syntax results -->\n\n${outputSyntax}\n<!-- end -->`
);

const diffs = [
  ["webpack-mjs", "node-mjs"],
  ["babel-mjs", "node-mjs"],
  ["babel-mjs", "babel-js"],
  ["webpack-mjs", "webpack-js"],
  ["webpack-mts", "webpack-js"],
  ["webpack-mts", "webpack-mjs"],
  ["esbuild-mjs", "esbuild-js"],
  ["esbuild-mts", "esbuild-ts"],
  ["esbuild-mts", "esbuild-mjs"],
];
...
for (const diff of diffs) {
  ...
  readme = readme.replace(
    new RegExp(`<!-- diff-${name} results -->.*?<!-- end -->`, "ms"),
    `<!-- diff-${name} results -->\n\n${output}\n\n<!-- end -->`
  );
}

...
const resultsFiles = fs.readdirSync(path.resolve(__dirname, "../results"))
  ...
  return runtimes.indexOf(aRuntime) - runtimes.indexOf(bRuntime);
});
...
const synthesizingDefaultExport = [["", ...esmVariants, ...cjsVariants, ""]];
...
in Node and how they behave in bundlers. Consequently, some modern bundlers adopt Node’s behavior and always
